...
import { Menu, Check, ArrowRight, Sparkles, Zap, Video, Target, Users, RefreshCw, Send, CheckCircle } from "lucide-react";
              ...
              <Sheet>
                ...
                <SheetContent side="right" className="bg-slate-900 border-white/10">
                  <nav className="flex flex-col space-y-4 mt-8">
                    ...
                    <Link to="/ai-studio" className="text-cyan-400 font-medium py-2 px-4 rounded-lg bg-cyan-500/10">AI Studio</Link>
